...
<body>
    <!--  header  -->
    <header>
        <h1  class="myhidden">FULLSTACK DEVELOPER SCK</h1>
        <div class="p-5 bg-primary text-white text-center myvisual">
            <h1>FLYSONMIR_MVC1 JSP PROJECT</h1>
            <p>Lorem ipsum...</p>
        </div> 
        <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
            <h2  class="myhidden">주메뉴</h2>
            <div class="container-fluid">
                <a class="navbar-brand" href="javascript:void(0)">SONMIR</a>
    ...
    <section class="container  my-5">
        ...
        <div  class="text-end">
           <a href="list2.jsp"  title="글쓰기 폼"  class="btn btn-primary" >글쓰기</a>
        </div>
