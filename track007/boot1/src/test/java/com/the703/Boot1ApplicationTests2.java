...
class Boot1ApplicationTests2 {
	...
	@Disabled  @Test  public void deleteService_User() {
		...
		user.setEmail("2@2");   user.setPassword("2");  user.setAppUserId(81);   // 81
	...
	@Disabled  @Test  public void updateService_User() {
		...
		user.setUfile("12.png"); user.setMobile("01022222222"); user.setNickname("22");
	...
	////////////////////////////////////////////////////////
	//6. 수정(동적 SQL)
	@Disabled @Test public void updateApp_User() {
		AppUserDto  user = new AppUserDto();
	...
	//1. 회원가입 - 유저등록 + 권한등록	
	@Disabled @Test  public void insert_User() { //1. 회원가입 - 유저등록 + 권한 등록
		AppUserDto user = new AppUserDto();
