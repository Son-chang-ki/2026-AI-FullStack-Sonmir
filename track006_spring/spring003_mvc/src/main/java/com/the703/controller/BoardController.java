...
//	<property name="prefix"  value="/view/"  />//  <property name="suffix"  value=".jsp"  />
	...
	public String list(Model model) { model.addAttribute("list", service.selectAll());
		return "board/list"; }
	...
	public String write_post(BoardDto dto, RedirectAttributes rttr) { String result = "글쓰기 실패";
