...
public class ModelTest001 {
    ...
    public void test6() {
    	...
    	//4. 수정
		UserInfoDto dto = new UserInfoDto(); dto.setEmail("hello@gmail.com");
		dto.setAge(100); dto.setNo(9); System.out.println(userinfo.update(dto));

    	//3. 한명검색
    	System.out.println(userinfo.select(9) );
    	
    	//2. 삽입
        UserInfoDto dto1 = new UserInfoDto(); dto1.setEmail("hi@gmail.com"); dto1.setAge(10);
    	System.out.println(userinfo.insert(dto1));
