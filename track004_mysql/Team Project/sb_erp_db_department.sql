...
INSERT INTO `sb_erp_db`.`department` 
(`dept_id`, `com_id`, `parent_id`, `dept_name`, `dept_code`, `depth`, `sort_order`, `emp_id`) 
VALUES 
(10, 1, NULL, '경영지원본부', 'DEPT_HQ_01', 1, 1, NULL),
(11, 1, 10, '인사팀', 'DEPT_TEAM_01', 2, 1, NULL);