...
class Product extends Object{ //상속을 받을께, Object(클래스의 기본틀), Object 생략가능
	  //인스턴스 변수
	   ...
	   // alt + shift + S
	   public Product() { super();  }   // ctrl + alt + j(한줄 정리) //super(); 생략가능 //super(부모) - Object()
	   
	   public Product(String name, int price) {
			super();
			this.name = name; // this => 1번지의 name 값 //this (각각의 내꺼)
			this.price = price; }  // this => 1번지의 price 값
...
public class Class004 {
	...
	public static void main(String[] args) {
		...
		Product p2 = new Product("아이폰17", 1500000);  //1)new 객체생성 2)생성자 -초기화  3) p2 주소갖기   (2번지)
		System.out.println(p2);  // p1(2번지) → 2번지: Product [name=null, price=0]
	}
