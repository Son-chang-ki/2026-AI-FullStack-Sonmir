...
public class Arr002 {
	...
	public static void main(String[] args) {
		...
		// ver-2
		//		int data = 0;
		//		arr2[0] = data; data+=10;   arr2[1] = data; data+=10;   arr2[2] = data; data+=10;
		
		int data = 0;
		//arr2[0] = data; data+=10;   arr2[1] = data; data+=10;   arr2[2] = data; data+=10;
		
		for(int i=0; i<arr2.length; i++)   { arr[i] = data; data+=10;}
		 
		for(int i =0; i<arr2.length; i++) {System.out.printf("%f" , arr2[i] + "\t");}
