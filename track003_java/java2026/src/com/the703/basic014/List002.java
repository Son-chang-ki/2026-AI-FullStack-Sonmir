...
//1. 클래스는 부품객체
//2. 상태(멤버변수: 클래스변수, 인스턴스 변수)와 행위(멤버함수)
...
//	public UserDto() { this.no = ++cnt;  } //유저번호 = 값 ; 값 1개 증가 후 다시 넣음
...
//	//1. 클래스가 맞는지 확인 (class UserDto, email / no)
...
public class List002 {
	public static void main(String[] args) {
	   ...
	   users.add(new UserDto("aaa@gmail.com")     ); // 주소값이 들어가 있어서
	   ...
	   int cnt=0;
	   for(UserDto a: users) {
		   System.out.println("INFO" + (cnt++ +1) + ":" + dto.getNo() + "/" + a.getEmail() );  }
	}
}
