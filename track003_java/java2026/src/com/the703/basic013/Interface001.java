...
//class Son extends Papa, Mama { } => 자바에서 상속은 단일상속

interface Animal2 {
	String company = "(주) 메가스터디" ; 
	//sf : static final - Animal2.company (클래스변수) method area, new X, this 각각 X
...
3. 프로젝트 진행시 interface 사용하면
 - 다른 구성원들이 각각의 부분을 완성할때까지 기다리지 않고 규약만 정해놓고 본인부부만 작성
