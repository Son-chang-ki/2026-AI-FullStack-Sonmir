...
/*                                 		  Object
 *    										 ↑
 *                                          Robot   { name = "기본로봇", void work() }
 *     ↑ 										↑								↑
 * CleaningRobot 							CookingRobot				  FightingRobot
 * { name = "청소로봇" 						name = "요리로봇"					name = "전투로봇"
 * void @work(),       						void @work() 					void @work()
 * void vacuum()	 }					 	void cook() 					void attack()

1)   부모									    =  자식 (업캐스팅)
2) { name = "기본로봇", void work() }          = 1번지 { name = "청소로봇" / @work()/ vacuum() } - { name = "기본로봇", void work() }  
 										    = 2번지 { name = "요리로봇" / @work()/ cook() } - { name = "기본로봇", void work() }
 										    = 3번지 { name = "전투로봇" / @work()/ attack() } - { name = "기본로봇", void work() }
...
abstract class Robot {
	 String name = "기본로봇";
	 public Robot() { super(); }
	 public abstract void  work(); //{ System.out.println("로봇이 하는일은?"); }// 추상 메서드
	} // end class
