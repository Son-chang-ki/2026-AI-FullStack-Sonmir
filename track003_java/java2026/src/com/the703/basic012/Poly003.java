...
public class Poly003 {
	public static void main(String[] args) {
		...
		// 3) 보장범위 : tb { b=20, toString} - { a=10, toString} = { a=10, toString} 
		// 다이캐스팅만 하고 생성자 불러 초기화 한 적이 없어 오류남
		//
 ...
 * cannot be cast to class com.the703.basic012.TestB3 
